    ...
    <footer className="bg-gradient-to-r from-indigo-900 to-indigo-700 text-white py-8 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-center md:text-left">
        <div>
          ...
          <p className="text-gray-300 mt-2">The Future of Real Estate, Reimagined</p>
        </div>
        {/*links*/}
      ...
      {/* Bottom Line */}
      <div className="border-t border-gray-500 mt-6 pt-4 text-center text-gray-300 text-sm">
